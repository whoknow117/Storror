            ...
            '1': [
                {
                    ...
                    items: [
                        ...
                        {title: 'Смесители для кухни',path:'/'},
                        {title: 'Смесители для ванной',path:'/'},
                        {title: 'Смесители для дачи',path:'/'},
                        {title: 'Электрические смесители',path:'/'},
                    ]
                ...
                },
                {
                    ...
                    path: '/santehnika',
                    items: [
                        {title: 'Трубы ПВХ', path: '/'},
                        {title: 'Трубы для пайки',path:'/'},
                        {title: 'Труба ПНД',path:'/'},
                ...
                },
                {
                    ...
                    path: '/santehnika',
                    items: [
                        {title: 'Поливочные шланги',path:'/'},
                        {title: 'Пищевая трубка ПВХ',path:'/'},
                        {title: 'Пожарный шланг',path:'/'},
                        {title: 'Шланги для душа',path:'/'},
                        {title: 'Шланги для стиральной машинки',path:'/'},
                        {title: 'Шланги для газвого счетчика',path:'/'},
                        {title: 'Шланги для слива стиральной машины',path:'/'},
                        {title: 'Шланги для подачи воды стиральной машины   ',path:'/'},
                    ]
